...
void main(){
    ...
    data.x = (u_y_global + (a_position.x-u_world_size.x/2f))/u_world_size.y;
    data.y = u_y_global/u_world_size.y;
    data.z = u_heightObject;
}